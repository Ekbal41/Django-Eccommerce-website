...
def sslcommerz_payment_gateway(request,  amount):
    ...
    post_body['success_url'] = 'http://127.0.0.1:8000/payment/payment/success'
    post_body['fail_url'] = 'http://127.0.0.1:8000/payment/payment/faild'
    ...
    # OPTIONAL PARAMETERS
    post_body['value_a'] = request.user.first_name +  ' ' + request.user.last_name
    post_body['value_b'] = request.user.email
